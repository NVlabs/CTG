...
class NuplanTrajdataPedTrainConfig(TrajdataTrainConfig):
    def __init__(self):
        super(NuplanTrajdataPedTrainConfig, self).__init__()
...
class NuplanTrajdataPedEnvConfig(TrajdataEnvConfig):
    def __init__(self):
        super(NuplanTrajdataPedEnvConfig, self).__init__()
