...
class L5KitTrajdataTrainConfig(TrajdataTrainConfig):
    def __init__(self):
        super(L5KitTrajdataTrainConfig, self).__init__()

        self.trajdata_cache_location = "~/.unified_data_cache"
        self.trajdata_source_train = ["lyft_train-train"]
        self.trajdata_source_valid = ["lyft_val-val"]
...
class L5KitTrajdataEnvConfig(TrajdataEnvConfig):
    def __init__(self):
        super(L5KitTrajdataEnvConfig, self).__init__()
