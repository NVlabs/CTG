...
class DriveSimTrajdataTrainConfig(TrajdataTrainConfig):
    def __init__(self):
        super(DriveSimTrajdataTrainConfig, self).__init__()

        self.trajdata_cache_location = "~/.unified_data_cache"
        self.trajdata_source_train = ["main"]
        self.trajdata_source_valid = ["main"]
...
class DriveSimTrajdataEnvConfig(TrajdataEnvConfig):
    def __init__(self):
        super(DriveSimTrajdataEnvConfig, self).__init__()
        ...
        self.data_generation_params.trajdata_max_agents_distance = 300.0
        ...
        self.data_generation_params.other_agents_num = 50